...
/**
 * Creates a computer tool for GLM models using OpenAI-compatible function calling
 *
 ...
 */
export const createGLMComputer = (browserTool: BrowserTool) => {
  return tool({
...
/**
 * Map of GLM computer tool actions to internal actions
 */
