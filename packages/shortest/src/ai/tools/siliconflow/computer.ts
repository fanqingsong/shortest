...
/**
 * Creates a computer tool for SiliconFlow models using OpenAI-compatible function calling
 *
 * SiliconFlow uses standard function calling via the OpenAI SDK, so we create
 * a tool that wraps the BrowserTool functionality in a compatible format
 */
export const createSiliconFlowComputer = (browserTool: BrowserTool) => {
  return tool({
...
/**
 * Map of SiliconFlow computer tool actions to internal actions
 */
