...
// src/log/config.ts
var LOG_LEVELS, LOG_FORMATS, LogConfigSchema;
var init_config = __esm({
  "src/log/config.ts"() {
    ...
    LOG_FORMATS = ["terminal", "pretty", "reporter"];
    LogConfigSchema = external_exports.object({
...
var ShortestError, ConfigErrorTypeSchema, ConfigError, AIErrorTypeSchema, AIError, CacheErrorTypeSchema, CacheError, ToolError, TestErrorTypeSchema, TestError, getErrorDetails, formatZodError, asShortestError;
var init_errors2 = __esm({
  "src/utils/errors.ts"() {
    "use strict";
    init_zod();
    ShortestError = class extends Error {
      type;
      constructor(message) {
        super(message);
    ...
    ConfigErrorTypeSchema = external_exports.enum([
      "duplicate-config",
      "file-not-found",
      "invalid-config",
      "multiple-config",
    ...
    ConfigError = class extends ShortestError {
      type;
    ...
    AIErrorTypeSchema = external_exports.enum([
      "invalid-response",
      "max-retries-reached",
    ...
    AIError = class extends ShortestError {
      type;
      constructor(type, message) {
        super(message);
    ...
    CacheErrorTypeSchema = external_exports.enum(["not-found", "invalid"]);
    CacheError = class extends ShortestError {
      type;
      constructor(type, message) {
        super(message);
    ...
    ToolError = class extends ShortestError {
      constructor(message) {
        super(message);
        this.name = "ToolError";
      }
    };
    TestErrorTypeSchema = external_exports.enum([
      "callback-execution-failed",
      "assertion-failed"
    ]);
    TestError = class extends ShortestError {
      type;
      actual;
      expected;
...
${errorsString}`;
    ...
    asShortestError = (error) => error instanceof Error ? Object.assign(new ShortestError(error.message), error, {
      name: "ShortestError"
...
// src/ai/tools/glm/computer.ts
var computer_exports = {};
__export(computer_exports, {
  createGLMComputer: () => createGLMComputer
});
import { tool as tool6 } from "ai";
var createGLMComputer, actionMap3;
var init_computer = __esm({
  "src/ai/tools/glm/computer.ts"() {
    "use strict";
    init_zod();
    init_browser();
    createGLMComputer = (browserTool) => {
      return tool6({
        ...
        parameters: external_exports.object({
          ...
          coordinate: external_exports.tuple([external_exports.number(), external_exports.number()]).optional().describe("X, Y coordinates for mouse actions"),
          coordinates: external_exports.tuple([external_exports.number(), external_exports.number()]).optional().describe("Start X, Y coordinates for drag operations"),
          text: external_exports.string().optional().describe("Text to type"),
          key: external_exports.object({
            type: external_exports.string().optional().describe("Key combination (e.g., 'ctrl+c')"),
            text: external_exports.string().optional().describe("Text representation of key")
          }).optional()
        }),
        execute: async (input2) => {
          const { action, ...restOfInput } = input2;
          const internalAction = actionMap3[action];
          if (!internalAction) {
            return {
...
// src/ai/tools/dashscope/computer.ts
var computer_exports2 = {};
__export(computer_exports2, {
  createDashScopeComputer: () => createDashScopeComputer
});
import { tool as tool8 } from "ai";
var createDashScopeComputer, actionMap4;
var init_computer2 = __esm({
  "src/ai/tools/dashscope/computer.ts"() {
    "use strict";
    init_zod();
    init_browser();
    createDashScopeComputer = (browserTool) => {
      return tool8({
        description: "Computer control tool for automating browser interactions",
        parameters: external_exports.object({
          action: external_exports.enum([
        ...
        execute: async (input2) => {
          const { action, ...restOfInput } = input2;
          const internalAction = actionMap4[action];
          if (!internalAction) {
            return {
              error: `Action '${action}' not supported`,
              output: `Action '${action}' not supported`
...
// src/ai/tools/dashscope/bash.ts
var bash_exports2 = {};
__export(bash_exports2, {
  createDashScopeBash: () => createDashScopeBash
});
import { tool as tool9 } from "ai";
var createDashScopeBash;
...
// src/ai/tools/siliconflow/computer.ts
var computer_exports3 = {};
__export(computer_exports3, {
  createSiliconFlowComputer: () => createSiliconFlowComputer
});
import { tool as tool10 } from "ai";
var createSiliconFlowComputer, actionMap5;
var init_computer3 = __esm({
  "src/ai/tools/siliconflow/computer.ts"() {
    "use strict";
    init_zod();
    init_browser();
    createSiliconFlowComputer = (browserTool) => {
      return tool10({
        description: "Computer control tool for automating browser interactions",
        parameters: external_exports.object({
          action: external_exports.enum([
        ...
        execute: async (input2) => {
          const { action, ...restOfInput } = input2;
          const internalAction = actionMap5[action];
          if (!internalAction) {
            return {
              error: `Action '${action}' not supported`,
              output: `Action '${action}' not supported`
...
// src/ai/tools/siliconflow/bash.ts
var bash_exports3 = {};
__export(bash_exports3, {
  createSiliconFlowBash: () => createSiliconFlowBash
});
import { tool as tool11 } from "ai";
var createSiliconFlowBash;
var init_bash3 = __esm({
  "src/ai/tools/siliconflow/bash.ts"() {
    "use strict";
    init_zod();
    init_bash_tool();
    createSiliconFlowBash = () => {
      const bashTool = new BashTool();
      return tool11({
        description: "Execute bash commands in the terminal",
        parameters: external_exports.object({
...
var toolEntrySchema = external_exports.union([
  external_exports.object({
    name: external_exports.literal("bash"),
    category: external_exports.literal("provider"),
...
var anthropicToolTypeSchema = external_exports.enum(["computer", "bash"]);
...
var ToolRegistry = class {
   ...
   * @private
   */
  getGLMTools(browserTool) {
    const tools = {};
    try {
      const { createGLMComputer: createGLMComputer2 } = (init_computer(), __toCommonJS(computer_exports));
      const computerTool = createGLMComputer2(browserTool);
      tools["computer"] = computerTool;
    } catch (error) {
      this.log.trace("Computer tool creation failed for GLM, skipping", { error });
    }
    try {
      const { createGLMBash: createGLMBash2 } = (init_bash(), __toCommonJS(bash_exports));
      const bashTool = createGLMBash2();
      tools["bash"] = bashTool;
    } catch (error) {
   ...
   * @private
   */
  getAzureTools(browserTool) {
    const tools = {};
    try {
      const { createAzureComputer } = __require("@/ai/tools/azure/computer");
    ...
    try {
      const { createAzureBash } = __require("@/ai/tools/azure/bash");
   ...
   * @private
   */
  getDashScopeTools(browserTool) {
    const tools = {};
    try {
      const { createDashScopeComputer: createDashScopeComputer2 } = (init_computer2(), __toCommonJS(computer_exports2));
      const computerTool = createDashScopeComputer2(browserTool);
      tools["computer"] = computerTool;
    } catch (error) {
      this.log.trace("Computer tool creation failed for DashScope, skipping", { error });
    }
    try {
      const { createDashScopeBash: createDashScopeBash2 } = (init_bash2(), __toCommonJS(bash_exports2));
      const bashTool = createDashScopeBash2();
      tools["bash"] = bashTool;
    } catch (error) {
   ...
   * @private
   */
  getSiliconFlowTools(browserTool) {
    const tools = {};
    try {
      const { createSiliconFlowComputer: createSiliconFlowComputer2 } = (init_computer3(), __toCommonJS(computer_exports3));
      const computerTool = createSiliconFlowComputer2(browserTool);
      tools["computer"] = computerTool;
    } catch (error) {
      this.log.trace("Computer tool creation failed for SiliconFlow, skipping", { error });
    }
    try {
      const { createSiliconFlowBash: createSiliconFlowBash2 } = (init_bash3(), __toCommonJS(bash_exports3));
      const bashTool = createSiliconFlowBash2();
      tools["bash"] = bashTool;
    } catch (error) {
  ...
  getProviderTools(provider, model, browserTool) {
    ...
    try {
      const computerToolEntry = this.getProviderToolEntry(
        provider,
        model,
        // Safe: GLM, Azure, DashScope, and SiliconFlow cases already handled
        "computer"
      );
...
// src/tools/index.ts
var toolToRegisterSchema = external_exports.union([
  external_exports.object({
...
var AIClient = class {
  ...
  constructor({
    ...
    this.log.trace(
      "Available tools",
      Object.fromEntries(
        Object.entries(this.tools).map(([name, tool12]) => [
          name,
          tool12.description || "No description"
        ])
      )
    );
  }
